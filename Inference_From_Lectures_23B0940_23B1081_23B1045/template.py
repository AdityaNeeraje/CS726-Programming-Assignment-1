    ...
    def min_neighbours_heuristic(self):
        ...
        while i>0:
            while simplicial:
                ...
                self.largest_clique_size=max(self.largest_clique_size, len(self.cliques_to_vertex_mapping[clique]))
...
class Inference:
    ...
    def triangulate_and_get_cliques(self):
        ...
        largest_clique_size=self.graph.largest_clique_size
        self.graph.restore_state()
        self.graph.min_fill_heuristic()
        # print(self.graph.largest_clique_size, largest_clique_size)
        if self.graph.largest_clique_size>largest_clique_size:
            self.graph.restore_state()
            self.graph.min_neighbours_heuristic()
...
if __name__ == '__main__':
    evaluator = Get_Input_and_Check_Output('Another_Testcase.json')
